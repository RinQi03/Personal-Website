...
const App = () => {
  ...
  useEffect(() => {
    ...
    const onEscape = (e) => e.key === 'Escape' && setShowBlurOverlay(false)
  ...
  useEffect(() => {
    ...
    imageObject.position.set(0, 0, -700)
    ...
    const onExperienceClick = () => setShowBlurOverlay(true)
    window.addEventListener('experience-click', onExperienceClick)

    // Cleanup
    return () => {
      window.removeEventListener('experience-click', onExperienceClick)
